...
def get_ai_proxy_token():
    """
    Retrieve the AI Proxy token.
    """
    return "eyJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6IjIzZjEwMDIwOTlAZHMuc3R1ZHkuaWl0bS5hYy5pbiJ9.8t-2_9K5aTxK-_ZAeWKFoXUuPT_FtqUhvFsK6-adXX4"

def generate_story_with_ai(summary_data):
    """
    Generate a story using GPT-4o-Mini via AI Proxy.
    """
    ...
    payload = {
        ...
        "messages": [
            ...
            {"role": "user", "content": f"Generate a story based on the following data insights: {summary_data}"}
        ],
        "max_tokens": 300,
    }
